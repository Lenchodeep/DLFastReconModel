    ...
    def __getitem__(self, i):
        ...
        with h5py.File(PDWIFilePath, 'r') as f, h5py.File(FSPDWIFilePath, 'r') as s:
            ...
            for slice in range(self.num_input_slices):
                ...
                masked_FSPDWIkspace, full_FSPDWIkspace, full_FSPDWIimg = self.slice_preprocess(FSPDWIkspace, slice)
                masked_PDWIkspace, full_PDWIkspace, full_PDWIimg = self.slice_preprocess(PDWIkspace, slice)
