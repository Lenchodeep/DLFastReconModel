...
def train(args):
    ...
    trainData = IXIDataSet(args.imageDataDir, args, True, transform = None)
    valData = IXIDataSet(args.imageDataDir, args, False, transform=None)
    ...
    try:
        for epoch in range(0, args.epochs):
            ...
            val_rec_img, val_full_img, val_ImL2, val_psnr = eval_net(model, val_loader, Loss, args.device)
            logging.info('Validation full score: {} PSNR: {}'
                .format(val_ImL2, val_psnr))
