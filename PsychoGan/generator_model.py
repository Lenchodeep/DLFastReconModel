...
class WNet(nn.Module):
    ...
    def __init__(self, args, masked_kspace=True):
        ...
        self.kspace_Unet = UNet(n_channels_in=args.num_input_slices, n_channels_out=2, bilinear=self.bilinear)
    ...
    def forward(self, Kspace):
        ...
        if self.masked_kspace:
            rec_Kspace = self.mask*Kspace+self.maskNot*rec_all_Kspace
