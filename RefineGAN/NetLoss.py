...
def cal_loss(S01, S01_k_un, S02, S02_k_un, mask, Sp1, S1, Tp1, T1, Sp2, S2, Tp2, T2, S1_dis_real, S1_dis_fake,
    ...
    if cal_G:
        ...
        frq_loss = recon_frq_AA + recon_frq_BB + recon_frq_Aa + recon_frq_Bb
        ...
        recon_img_loss = recon_img_AA+recon_img_BB+recon_img_Aa+recon_img_Bb
        error_img_loss = error_img_AA + error_img_BB +error_img_Aa + error_img_Bb
        gradient_loss = smoothness_AA + smoothness_BB + smoothness_Aa + smoothness_Bb
        G_loss = G_loss_AA + G_loss_BB + G_loss_AB + G_loss_BA + G_loss_Aa + G_loss_Bb + G_loss_Ab + G_loss_Ba
        ALPHA = 1e+1
        GAMMA = 1e-0
        DELTA = 1e-4
        ...
        return g_loss,recon_img_loss,error_img_loss,gradient_loss,frq_loss,G_loss,[G_loss_AA, G_loss_Aa, recon_img_AA, recon_img_Aa, error_img_AA, error_img_Aa, recon_frq_AA,
